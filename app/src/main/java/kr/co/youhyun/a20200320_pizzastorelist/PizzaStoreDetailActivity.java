...
//                크게 보는 액티비티로 이동 => 봐야할 이미지의URL만 전달
...
//                        권한을 사용자가 거부한 상황 => 전화 권한을 허가해야 사용가능합니다. Toast 띄우기
                        Toast.makeText(mContext, "전화권한을 허가해야 사용가능합니다.", Toast.LENGTH_SHORT).show();
                    }
                };

//                onClick 실행? 사용자가 손으로 클릭할 때 실행
